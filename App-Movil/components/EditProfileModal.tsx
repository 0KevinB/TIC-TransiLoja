  ...
  const handleSave = async () => {
    ...
    try {
      const updateData = {
        ...
        // email: email.trim(), // Email is not editable
        preferences: {
      ...
      // No aplicar cambios de tema/fuente aquí - se hace desde configuración
            ...
            <Card margin="md">
              ...
              <ThemedView style={styles.infoRow}>
                ...
                <ThemedText variant="body" weight="medium">
                  {userProfile?.createdAt && userProfile.createdAt instanceof Date
              ...
              <ThemedView style={styles.infoRow}>
                ...
                <ThemedText variant="body" weight="medium">
                  {userProfile?.updatedAt && userProfile.updatedAt instanceof Date
